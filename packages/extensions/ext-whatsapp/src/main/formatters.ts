// ============================================================================
// OpenOrbit — WhatsApp Message Formatters
//
// Format OpenOrbit data for WhatsApp. Uses *bold* formatting (supported
// natively by WhatsApp). No inline keyboards — approve/reject via text.
// ============================================================================
