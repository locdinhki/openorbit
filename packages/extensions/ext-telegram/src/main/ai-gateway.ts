// ============================================================================
// OpenOrbit — Telegram AI Gateway
//
// Routes incoming Telegram messages through the Claude Agent SDK with
...
You help the user manage their automated job search from their phone via Telegram.
...
export class AIGateway {
  ...
  /**
   * Process a callback action (inline keyboard button press).
